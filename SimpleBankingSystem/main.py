...
while running:
    ...
    if choice == 1:
        ...
        print()
        client = User(input("Name: "), int(input("Deposit amount: ")))
        bank.add_users(client)
        print()
        print("Account created successfully! Your account number is: ", User.account['account_number'])
    elif choice == 2:
        print()
